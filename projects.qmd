...
## Walking Manhattan
::: {#map_canvas_walking .img-float style="float: right; width: 512px; height: 400px"}
:::
...
## Flight Map
::: {#map_canvas_flying .img-float style="float: right; width: 512px; height: 400px"}
:::
...
## 1 second everyday
::: {.img-float}
![](images/project-1se.webp){style="float: right; margin: 5px; width: 512px"}
:::
...
::: {.img-float}
![](images/project-aaa.webp){style="float: right; margin: 5px; width: 512px"}
:::
...
## APOD Wallpaper
::: {.img-float}
![](images/project-apod.webp){style="float: right; margin: 5px; width: 512px"}
:::
This Python script is meant to automatically execute every day and will download the current Astronomy Picture of the Day ([APOD](http://apod.nasa.gov/apod/astropix.html)) and set it as the desktop background.  It currently only supports setting the background picture on Windows using the WIN32 API.

[GitHub](https://github.com/alexanderbock/apodwallpaper), Python
